...
class Uniform:
    '''
    Create a simple class to handle uniforms
...
class BaseShaderProgram:
    ...
    def __init__(self, name=None, vertex_shader=None, fragment_shader=None):
        ...
        # In order to simplify extension of the class in the future, start storing uniforms in a dictionary.
        self.uniforms = {
...
class PhongShader(BaseShaderProgram):
    ...
    def bind_material_uniforms(self, material):
        # For the materials these usually have properties to do with shading
